...
class DashboardInduk_model extends CI_Model
{
	...
	var $column_order 		= array('null', 'manage_survey.survey_name', 'manage_survey.organisasi', 'manage_survey.survey_start', 'manage_survey.survey_end', 'null', 'null');
	...
	private function _get_datatables_query($parent)
	{
        ...
        if ($this->input->post('id_akun_anak')) {
            $this->db->where('id_user', $this->input->post('id_akun_anak'));
        }else{
