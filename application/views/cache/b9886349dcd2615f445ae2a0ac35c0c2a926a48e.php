    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form_edit" action="<?php echo e(base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/pertanyaan-harapan/edit'); ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="radio-list">
                                <label class="radio">
                                    <input type="radio" name="model_pilihan_jawaban" value="1" class="model_pilihan_jawaban" <?php echo e($manage_survey->is_model_pertanyaan_harapan == 1 ? 'checked' : ''); ?>><span></span>2 Pilihan Jawaban
                                </label>
                                <label class="radio">
                                    <input type="radio" name="model_pilihan_jawaban" value="2" class="model_pilihan_jawaban" <?php echo e($manage_survey->is_model_pertanyaan_harapan == 2 ? 'checked' : ''); ?>><span></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\mk_skm\application\views/pertanyaan_harapan_survei/index.blade.php ENDPATH**/ ?>