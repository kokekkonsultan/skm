                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover mt-8">
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <?php $__currentLoopData = $grafik->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($row->kuadran == 1): ?>
                                    <li><?php echo e($row->nomor_unsur . '. ' . $row->nama_unsur_pelayanan); ?></li>
                                    <hr>
                                    <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table width="100%" class="table table-bordered" style="font-size: 12px;">
                            ...
                            <tr class="bg-light">
                                ...
                                <?php $__currentLoopData = $persepsi->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td>
                    ...
                    <div class="table-responsive">
                        <table width="100%" class="table table-bordered" style="font-size: 12px;">
                            ...
                            <tr class="bg-light">
                                ...
                                <?php $__currentLoopData = $persepsi->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object_harapan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td>
                                    <div align="center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\mk_skm\application\views/kuadran/index.blade.php ENDPATH**/ ?>