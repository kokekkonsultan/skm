        ...
        <div class="col-md-9">
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <input type="text" name="id_jenis_jawaban" value="{{$current->id_jenis_pilihan_jawaban}}"
                        hidden>
                    ...
                    <input type="hidden" class="form-control" id="id_kategori" name="id_kategori[]"
                        value="{{$row->id_isi_pertanyaan_ganda}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control {{$row->pertanyaan_ganda == 'Lainnya' ? 'bg-light' : ''}}" id="pertanyaan_ganda" name="pertanyaan_ganda[]" value="{{$row->pertanyaan_ganda}}" 
