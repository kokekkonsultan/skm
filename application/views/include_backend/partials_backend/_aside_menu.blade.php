...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}link-survey-surveyor-induk" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}data-perolehan-surveyor-induk" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
    ...
    <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}klasifikasi-periode" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}kelompok-akun" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}duplikat-survei" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
    ...
    <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}rekap-surveyor-induk" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
    ...
    <li class="menu-item {{ ($ci->uri->segment(1) == 'olah-data-per-bagian') ? 'menu-item-active' : '' }}"
        aria-haspopup="true">
    ...
    <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}nilai-unsur-per-bagian" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
                ...
                @endphp
                <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                    <a href="{{ base_url() }}indeks-kelompok" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                        </i>
