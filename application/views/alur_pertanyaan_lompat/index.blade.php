                ...
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <a class="btn btn-secondary font-weight-bold"
                            href="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/pertanyaan-unsur'}}"><i
        ...
        <div class="dropdown">
                            ...
                            <td>
                                <div class="radio-inline" style="font-size: 14px;">
                                    <label class="radio radio-outline radio-success">
                                        <input type="radio" name="{{$pt_a->nomor_pertanyaan_terbuka}}"><span></span>
            ...
            <div class="card card-body mb-5 mt-5" style="border-left: 5px solid #0091ff;">
                <table class="table table-bordered" style="font-size: 14px;">
                    ...
                    @foreach($ci->db->query("SELECT * FROM kategori_unsur_pelayanan_$table_identity WHERE
                    id_unsur_pelayanan
                    =
                ...
                <table class="table table-bordered" style="font-size: 14px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="radio-inline" style="font-size: 14px;">
                                <label class="radio radio-outline radio-success">
                                    <input type="radio" name="{{$pt->nomor_pertanyaan_terbuka}}"><span></span>
                ...
                <table class="table table-bordered" style="font-size: 14px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="radio-inline" style="font-size: 14px;">
                                <label class="radio radio-outline radio-success">
                                    <input type="radio" name="{{$pt_b->nomor_pertanyaan_terbuka}}"><span></span>
