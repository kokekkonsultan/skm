...
$route['(:any)/manage-survey/create-survey'] = 'ManageSurveyController/add/$1';
$route['(:any)/manage-survey/save-survey'] = 'ManageSurveyController/create/$1';
...
$route['(:any)/(:any)/laporan-survey/download-pdf'] = 'ReportController/download_pdf/$1/$2';
