...
<body>
    <div style="font-weight: bold; text-transform:uppercase; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        ...
        <img src="<?php echo base_url() ?>assets/klien/foto_profile/200px.jpg" height="90" alt=""
            style="float:left; margin:0px 8px 8px 10px;">
        <?php else : ?>
        <img src="<?php echo base_url(); ?>assets/klien/foto_profile/<?php echo $user->foto_profile ?>" height="90"
            alt="" style="float:left; margin:0px 8px 8px 10px;">
        <?php endif; ?>

        <br>
        <div style="margin-left: 20px; padding: 8px; font-size:14px;">
            SURVEI KEPUASAN MASYARAKAT<br>
            <?php echo $manage_survey->organisasi ?><br>
